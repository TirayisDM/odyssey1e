...
fn list_encounters(state: State<AppState>, game_id: String) -> Result<Value, String> {
    ...
    supabase::rest_get(
        ...
        "encounters",
        &[
            ("select", "id,name,status,location_id,narrative,archived,round,turn_actor_id,created_at"),
            ("game_id", &format!("eq.{}", game_id)),
            ("order", "created_at.desc"),
        ],
    )
...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::store::quote_trade,
            commands::store::execute_trade,
            ...
            commands::inventory::save_object_technique,
            commands::inventory::remove_object_technique,
            commands::inventory::clear_object_technique,
            ...
            commands::locations::list_objects,
            commands::dm::set_encounter_location,
            commands::dm::edit_encounter,
            commands::dm::set_encounter_archived,
